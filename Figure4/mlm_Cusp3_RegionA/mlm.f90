!----------------------------------------------------------------------
!----------------------------------------------------------------------
!   mlm.f90 - May-Leonard with mutations
!----------------------------------------------------------------------
!----------------------------------------------------------------------
...
! Normally unused Jacobian arguments : IJAC, DFDU, DFDP (see manual)
  ...
  F(1)= m1*(1 -m1 -alpha*m2 -beta*m3) + mu*(-2*m1 +m2 +m3)
...
! Initialize the solution (from double)
!U(1) = 1.097790579070710d0
!U(2) = -2.367822019077263d0
!U(3) = 0.004805336341198d0

! Initialize the solution (from single)
U(1) = 1.053322500762794d0
U(2) = 0.013654169988272d0
U(3) = -0.038464852799998d0
